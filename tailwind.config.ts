  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // shadcn/ui colors (dark theme optimized)
      ...
      backgroundImage: {
        ...
        'pixan-gradient': 'linear-gradient(135deg, #14192B 0%, #4B2A9A 100%)',
        'pixan-gradient-reverse': 'linear-gradient(135deg, #4B2A9A 0%, #14192B 100%)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      keyframes: {
        ...
        'glitch': {
          ...
          '30%': { transform: 'translateX(0) scaleY(1)' },
